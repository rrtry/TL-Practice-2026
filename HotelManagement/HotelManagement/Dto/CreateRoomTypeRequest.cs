...
public class CreateRoomTypeRequest
{
    ...
    [Required( ErrorMessage = "RoomType DailyPrice is required" )]
    ...
    [Required( ErrorMessage = "RoomType MaxPersonCount is required" )]
    [Range( 1, int.MaxValue, ErrorMessage = "RoomType MaxPersonCount must be >= 1" )]
    public int? MaxPersonCount { get; set; }

    [Required( ErrorMessage = "RoomType AvailableRoomCount is required" )]
